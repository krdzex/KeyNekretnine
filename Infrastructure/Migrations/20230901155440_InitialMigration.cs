        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name_sr = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
                    name_en = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_advert_purposes", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    name_sr = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    name_en = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_advert_statuses", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    name_sr = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    name_en = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_advert_types", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    social_media_twitter_url = table.Column<string>(type: "text", nullable: true),
                    social_media_facebook_url = table.Column<string>(type: "text", nullable: true),
                    social_media_instagram_url = table.Column<string>(type: "text", nullable: true),
                    social_media_linkedin_url = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description_sr = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
                    description_en = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: false),
                    ...
                    purpose_id = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    type_id = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    created_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    user_id = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "id", "name_en", "name_sr" },
                values: new object[,]
                {
                    { 1, "Rent", "Rentiranje" },
                    { 2, "Sale", "Prodaja" },
                    { 3, "Short term rent", "Stan na dan" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Accepted", "Prihvacen" },
                    { 2, "Pending", "Na cekanju" },
                    { 3, "Declined", "Odbijen" },
                    { 4, "Uploading", "Dodavanje u procesu" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "House", "Kuca" },
                    { 2, "Apartman", "Stan" },
                    { 3, "Office space", "Poslovni prostor" },
                    { 4, "Land lot", "Zemljiste" }
                });
