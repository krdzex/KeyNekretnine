...
namespace KeyNekretnine.Infrastructure.Migrations
{
    ...
    [Migration("20241007001403_AddNullableToOldAndNewUpdateContent")]
    partial class AddNullableToOldAndNewUpdateContent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KeyNekretnine.Domain.Images.Image", b =>
                {
                    ...
                    b.Property<bool>("IsForUpdate")
                        .HasColumnType("boolean")
                        .HasColumnName("is_for_update");
            ...
            modelBuilder.Entity("KeyNekretnine.Domain.Adverts.Advert", b =>
                {
                    ...
                    b.OwnsOne("KeyNekretnine.Domain.ValueObjects.Location", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("KeyNekretnine.Domain.Agencies.Agency", b =>
                {
                    ...
                    b.OwnsOne("KeyNekretnine.Domain.ValueObjects.SocialMedia", "SocialMedia", b1 =>
                        {
                            b1.Property<Guid>("AgencyId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("KeyNekretnine.Domain.ValueObjects.TimeRange", "WorkHour", b1 =>
                        {
                            b1.Property<Guid>("AgencyId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
